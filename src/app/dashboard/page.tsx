      ...
      <div className={`max-w-7xl mx-auto transition-all ${showInvestPane ? "ml-[500px]" : ""}`}>
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={() => router.push(`/workflows?tenantId=${tenantId}&subscriptionId=${subscriptionId}`)}
            ...
            <button
              onClick={() => router.push(`/skills?tenantId=${tenantId}&subscriptionId=${subscriptionId}`)}
              className="px-3 py-1.5 rounded-lg text-sm font-medium bg-gray-200 hover:bg-gray-300 dark:bg-gray-800 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300"
            >
              🧠 Skills
            </button>
            <button
              onClick={() => router.push(`/my-catalog?tenantId=${tenantId}&subscriptionId=${subscriptionId}`)}
              className="px-3 py-1.5 rounded-lg text-sm font-medium bg-gray-200 hover:bg-gray-300 dark:bg-gray-800 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300"
            >
              📁 My Catalog
            </button>
